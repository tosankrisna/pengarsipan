<x-app-layout>
    <div class="w-100 h-screen bg-white">
        <div class="w-100">
            ...
            <form class="bg-white px-8 pt-6 pb-8 w-1/2" action="{{ route('siswa.store') }}" method="post">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="no_induk" name="no_induk" type="number" value="{{ old('no_induk') }}" placeholder="Masukan NIS">
                    @error('no_induk')
                        <p class="text-red-600 text-sm">{!! $message !!}</p>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nisn" name="nisn" type="number" value="{{ old('nisn') }}" placeholder="Masukan NISN">
                    @error('nisn')
                        <p class="text-red-600 text-sm">{!! $message !!}</p>
                    @enderror
                </div>
